...
`@changesets/changelog-github` adds pull-request and contributor links during versioning, so do not duplicate them manually. Release commits and pull-request titles remain semantic and do not include the codename.
