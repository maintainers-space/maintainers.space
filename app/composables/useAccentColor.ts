...
/**
 * A small rounded-square koinon glyph tinted to the given accent —
...
export function accentFaviconDataUri(accentId: string): string {
  ...
  const svg =
    `<svg xmlns="http://www.w3.org/2000/svg" viewBox="-60 -60 457 457" fill="none">` +
    `<defs>` +
    ...
    `</defs>` +
    `<path d="M 168.5 -50 C 185 -50 198 -45 210 -38 L 338 36 C 350 43 365 52 372 64 C 379 76 380 88 380 105 L 380 232 C 380 249 379 261 372 273 C 365 285 350 294 338 301 L 210 375 C 198 382 185 387 168.5 387 C 152 387 139 382 127 375 L -1 301 C -13 294 -28 285 -35 273 C -42 261 -43 249 -43 232 L -43 105 C -43 88 -42 76 -35 64 C -28 52 -13 43 -1 36 L 127 -38 C 139 -45 152 -50 168.5 -50 Z" fill="${bg}"/>` +
    `<g mask="url(#m0)">` +
